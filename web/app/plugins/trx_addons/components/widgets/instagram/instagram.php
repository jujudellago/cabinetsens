...
if ( !function_exists( 'trx_addons_widget_instagram_get_client_id' ) ) {
	function trx_addons_widget_instagram_get_client_id() {
		return trx_addons_check_option('api_instagram_client_id')
				? trx_addons_get_option('api_instagram_client_id')
				: 'dacc2025c9084968b5c14aceea1404e1';
	}
}
...
if ( !function_exists( 'trx_addons_widget_instagram_get_client_secret' ) ) {
	function trx_addons_widget_instagram_get_client_secret() {
		return trx_addons_check_option('api_instagram_client_secret')
				? trx_addons_get_option('api_instagram_client_secret')
				: '';
	}
}
