...
//------------------------------------------------------------------------
// Set plugin's specific importer options
if ( !function_exists( 'trx_addons_ocdi_easy_digital_downloads_set_options' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_options', 'trx_addons_ocdi_easy_digital_downloads_set_options' );
	function trx_addons_ocdi_easy_digital_downloads_set_options($ocdi_options){
...
if ( !function_exists( 'trx_addons_ocdi_easy_digital_downloads_export' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_export_files', 'trx_addons_ocdi_easy_digital_downloads_export' );
	function trx_addons_ocdi_easy_digital_downloads_export($output){
		$list = array();
...
if ( !function_exists( 'trx_addons_ocdi_easy_digital_downloads_import_field' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_import_fields', 'trx_addons_ocdi_easy_digital_downloads_import_field' );
	function trx_addons_ocdi_easy_digital_downloads_import_field($output){
		$list = array();
		if (trx_addons_exists_edd() && in_array('easy-digital-downloads', trx_addons_ocdi_options('required_plugins'))) {
...
if ( !function_exists( 'trx_addons_ocdi_easy_digital_downloads_import' ) ) {	
	if (is_admin()) add_action( 'trx_addons_action_ocdi_import_plugins', 'trx_addons_ocdi_easy_digital_downloads_import', 10, 1 );
	function trx_addons_ocdi_easy_digital_downloads_import($import_plugins){		
...
// Process post meta 
if ( !function_exists( 'trx_addons_ocdi_easy_digital_downloads_post_meta' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_process_post_meta', 'trx_addons_ocdi_easy_digital_downloads_post_meta', 10, 2 );
	function trx_addons_ocdi_easy_digital_downloads_post_meta( $keys, $import_plugins ){
