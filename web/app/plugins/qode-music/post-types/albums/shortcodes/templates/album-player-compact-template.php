<div class="qode-audio-player-wrapper <?php echo esc_attr($player_classes) ?>" >
	...
	<?php endif; ?>
	<div id= "qode-player-container-<?php echo esc_attr($player_id); ?>" class="qode-audio-player-holder qode-audio-player-compact " data-album-id="<?php echo esc_attr($album); ?>" <?php qode_music_inline_style($player_styles); ?>>
