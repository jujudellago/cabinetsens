...
if( isset( $is_elementor ) && $is_elementor ){
    $this_object = qode_listing_elementor_categories_class_instance();
} else{
	...
	<div class="qode-ls-gallery-inner clearfix">
		...
		<?php
			if(is_array($query_results) && count($query_results)){
				...
				$html = qode_listing_get_shortcode_module_template_part('templates/post-not-found', 'listing-categories', '', $params);
			}
			wp_reset_postdata();
			print $html;
		?>
