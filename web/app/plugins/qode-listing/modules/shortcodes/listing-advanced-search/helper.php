...
if(!function_exists('qode_listing_elementor_adv_search_class_instance')){

	function qode_listing_elementor_adv_search_class_instance(){
		return ElementorShortcodes\QodeListingElementorAdvancedSearch::getInstance();
	}
