  ...
  <div class="<?php echo esc_attr( $this->getInfiniteScrollGrid() );?>">
    ...
    <?php 
      ...
      <div class="otw-twelve otw-columns <?php echo $endClass;?>">
        ...
        <article class="otw_blog_manager-blog-full icon__small otw_blog_manager-blog-image-left <?php echo $this->containerBG; ?> <?php echo $this->containerBorder; ?><?php echo $this->postClass( $post );?>">
