...
<section class="otw-twentyfour otw-columns otw-bm-list-section" id="otw-bm-list-<?php echo $this->listOptions['id'];?>">
  ...
  <div class="otw-row">
    ...
    ?>
      ...
      <div class="<?php echo esc_attr( $class );?> otw_blog_manager-iso-item otw_blog_manager-blog-newspaper-item <?php echo $categoriesString;?><?php echo $this->postClass( $post );?>">
