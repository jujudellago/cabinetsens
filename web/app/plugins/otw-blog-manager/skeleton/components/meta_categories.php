...
<div class="otw_blog_manager-blog-category">
  ...
  <span class="head"><?php esc_html_e('Category:', 'otw_bm');?></span>
  <?php else: ?>
  ...
  ?>
  <a href="<?php echo esc_attr( esc_url($catUrl) );?>" rel="category" title="<?php esc_attr_e('View all posts in ', 'otw_bm'); echo $category->name;?>">
