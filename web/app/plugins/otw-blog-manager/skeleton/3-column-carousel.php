...
<div 
  ...
  data-item-margin="20"
  data-nav="<?php echo esc_attr( $this->listOptions['slider_nav'] );?>" 
  data-auto-slide="<?php echo esc_attr( $this->listOptions['slider-auto-scroll'] );?>">
  <ul class="slides">
    <?php 
    ...
    ?>
    <li class="otw_carousel_item<?php echo $this->postClass( $post );?>">
      ...
      <div class="otw_blog_manager-flex-caption otw_blog_manager-flex-caption--small <?php echo $cationBG;?>">
        ...
        <h3 class="otw_blog_manager-caption-title otw_blog_manager--small-title" data-item="title">
          <?php if( !empty($widgetTitleLink) ) : ?>
            <a href="<?php echo esc_attr( $widgetTitleLink );?>" class="otw-slider-image"><?php echo esc_html( $post->post_title );?></a>
          <?php else: ?>
