...
<section class="otw-twentyfour otw-columns otw-bm-list-section" id="otw-bm-list-<?php echo $this->listOptions['id'];?>">
  ...
  <div class="<?php echo esc_attr( $this->getInfiniteScrollGrid() );?>">
    ...
    <?php 
      ...
      foreach( $items as $postItem ):
        ...
        <div class="otw-six otw-columns <?php echo $endClass;?>">
          <article class="otw_blog_manager-blog-full icon__small otw_blog_manager-blog-newspaper-item <?php echo $this->containerBG; ?> <?php echo $this->containerBorder; ?><?php echo $this->postClass( $post );?>">
