  ...
  <ul class="bm_clearfix">
    <li class="widget otw_blog_manager-widget-blog-latest left-image bm_clearfix">
      ...
      <ul class="bm_clearfix js-widget-list">
        ...
        ?>
        <li class="otw_blog_manager-format-image otw_blog_manager-blog-full <?php echo $this->containerBG; ?> <?php echo $this->containerBorder; ?><?php echo $this->postClass( $widgetPost );?>">
