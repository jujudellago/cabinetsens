<?php
namespace QodeRestaurant\CPT;

use QodeRestaurant\Lib;

/**
 * Class PostTypesLoader
 * @package QodeRestaurant\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
	    $cpt_class_name = apply_filters('qode_restaurant_filter_register_custom_post_types', $cpt_class_name = array());
