...
if(!function_exists('qode_quick_links_load_meta_boxes')) {
	...
	add_action('bridge_qode_action_before_meta_boxes_map', 'qode_quick_links_load_meta_boxes');
	...
	add_action('bridge_qode_action_before_options_map', 'qode_quick_links_load_admin');
}
//load custom styles
