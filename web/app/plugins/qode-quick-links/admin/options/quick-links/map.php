...
if(qode_quick_links_theme_installed()) {
	if(!function_exists('qode_quick_links_map_map')) {
		...
		function qode_quick_links_map_map() {
			...
			// Quick Links Panel
			$panel_quick_links = bridge_qode_add_admin_panel(array(
				'page'  => '_quick_links',
			...
			$quick_links_container = bridge_qode_add_admin_container(
				array(
			...
			$typography_title_group = bridge_qode_add_admin_group(array(
			...
			$typography_title_row = bridge_qode_add_admin_row(array(
			...
			$typography_title_row2 = bridge_qode_add_admin_row(array(
			...
			$typography_text_group = bridge_qode_add_admin_group(array(
			...
			$typography_text_row = bridge_qode_add_admin_row(array(
			...
			$typography_text_row2 = bridge_qode_add_admin_row(array(
		...
		add_action('bridge_qode_action_options_map', 'qode_quick_links_map_map', 72); //one after elements
	}
}