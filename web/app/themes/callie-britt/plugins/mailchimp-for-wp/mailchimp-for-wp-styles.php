...
if (!function_exists('callie_britt_mailchimp_get_css')) {
	add_filter('callie_britt_filter_get_css', 'callie_britt_mailchimp_get_css', 10, 2);
	function callie_britt_mailchimp_get_css($css, $args) {
...
form.mc4wp-form .mc4wp-form-fields input[disabled="disabled"]:hover {
