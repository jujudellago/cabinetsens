...
if ( !function_exists( 'callie_britt_trx_addons_add_theme_vars' ) ) {
	add_filter( 'callie_britt_filter_add_theme_vars', 'callie_britt_trx_addons_add_theme_vars', 10, 2 );
	function callie_britt_trx_addons_add_theme_vars($rez, $vars) {
...
if (!function_exists('callie_britt_trx_addons_get_css')) {
	add_filter('callie_britt_filter_get_css', 'callie_britt_trx_addons_get_css', 10, 2);
	function callie_britt_trx_addons_get_css($css, $args) {
...
.trx_addons_custom_list__item-number {
	color: {$colors['bg_color']};
	background-color: {$colors['text_hover']};
}
...
.widget .trx_addons_tabs .post_title a:hover {
...
/* Action */
.sc_action_item.sc_action_item_simple .sc_action_item_subtitle {						color:{$colors['inverse_text']}; }
...
.sc_action_item_simple .sc_action_item_icon > span:hover {
...
.sc_blogger_item_excerpt .sc_button.sc_button_simple {
	color:{$colors['inverse_text']};
	background-color: {$colors['text_hover']};
}
.sc_blogger_item_excerpt .sc_button.sc_button_simple:hover {
	background-color: {$colors['text_link']};
}
...
.sc_events_detailed .sc_events_item_title:before {
	border-color: {$colors['alter_bd_color']};
}
.sc_events_detailed .sc_events_item {
...
.sc_price_item_link.sc_button:hover  {
	background-color: {$colors['alter_link_07']}!important;
}
...
.sc_services_default .with_icon.sc_services_item_featured_left,
...
.sc_services_default .with_icon.sc_services_item_featured_right .sc_services_item_icon {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_hover']};
...
.sc_services_default .sc_services_item.with_pictogram .sc_services_item_pictogram {
	color: {$colors['inverse_text']};
	background-color: {$colors['inverse_text']};
}
.sc_services_default .sc_services_item.with_pictogram .sc_services_item_pictogram:after {
	background-color: {$colors['alter_link']};
}
.sc_services_default .sc_services_item.with_pictogram .sc_services_item_pictogram:hover:after {
	background-color: {$colors['text_hover2']};
}
/* Custom_services_pictigram */
.sc_services_default.custom_services_pictogram .sc_services_item.with_pictogram .sc_services_item_pictogram {
	background-color: {$colors['alter_hover3']};
}
.sc_services_default.custom_services_pictogram .sc_services_item.with_pictogram .sc_services_item_pictogram:after {
	background-color: {$colors['alter_link']};
}
.sc_services_default.custom_services_pictogram .sc_services_item.with_pictogram .sc_services_item_pictogram:hover:after {
	background-color: {$colors['text_hover2']};
}
...
.sc_services_timeline .sc_services_item.with_number:hover .sc_services_item_number {
	background-color: transparent;
	border-color: transparent;
}
...
.sc_services .sc_button.sc_button_simple:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
...
.sc_services.sc_services_default.sc_services_featured_top 
.sc_services_item_info h4.sc_services_item_title a:hover {
	color: {$colors['text_hover2']};
}
.sc_services.sc_services_timeline.sc_services_featured_top 
.sc_services_item_info h4.sc_services_item_title a:hover {
	color: {$colors['text_hover2']};
}
...
.sc_action .sc_action_item_link.sc_button.sc_button_size_small:hover  {
	background-color: {$colors['input_bd_hover']}!important;
	color: {$colors['input_bd_hover']};
}
.sc_action .sc_action_item_link.sc_button.sc_button_size_small:hover:after {
	color: {$colors['inverse_link']};
}
...
.sc_skills.sc_skills_pie.sc_skills_compact_off.sc_skills .sc_skills_total {
	color:{$colors['text_dark']};
}
...
.sc_testimonials_item_content:after {
	border-bottom-color: {$colors['alter_hover2']};
}
