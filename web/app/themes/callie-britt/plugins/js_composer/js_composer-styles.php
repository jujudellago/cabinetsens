...
if ( !function_exists( 'callie_britt_vc_get_css' ) ) {
	add_filter( 'callie_britt_filter_get_css', 'callie_britt_vc_get_css', 10, 2 );
	function callie_britt_vc_get_css($css, $args) {
