...
$pagination = '';
if($cpt === 'sc_testimonials' && !empty($args['slider_pagination_buttons'])) { 
	if($cpt === 'sc_testimonials' && !empty($args['slider_pagination_buttons_thumbs'])) { 
		$pagination .= '<div class="slider_pagination_wrap_thumbs">'
					. (!empty($args['slider_pagination_buttons_thumbs']) ? $args['slider_pagination_buttons_thumbs'] : '')
				. '</div>';
	}
...
// For the other post types
if($cpt !== 'sc_testimonials') {
	$pagination .= '<div class="slider_pagination_wrap swiper-pagination">'
				. (!empty($args['slider_pagination_buttons']) ? $args['slider_pagination_buttons'] : '')
			. '</div>';
}
