...
if (!function_exists('callie_britt_customizer_get_css')) {

	function callie_britt_customizer_get_css($args=array()) {
		...
		if ($fonts) {
			...
			$fonts = callie_britt_customizer_add_theme_fonts($fonts);
...
.post_item_single.post_type_page.post-91.page.type-page.status-publish.hentry li span,
...
.sc_services_timeline .sc_services_item.with_number .sc_services_item_number,
...
.sc_layouts_row_type_normal .sc_layouts_iconed_text .sc_layouts_item_details_line1.sc_layouts_iconed_text_line1,
.sc_layouts_row_type_compact .sc_layouts_item_details_line2,
/*.footer_wrap .sc_layouts_widgets ul > li > a,*/
.sc_services_item.with_pictogram .sc_services_item_pictogram:after,
.services_page_tabs.trx_addons_tabs .trx_addons_tabs_titles li > a,
.comments_wrap .form-submit input[type="submit"],
.sc_form_form button,
div.ui-widget button,
.menu_mobile .search_mobile input.search_field[type="text"],
...
CSS;
			$rez = apply_filters('callie_britt_filter_get_css', $rez, array('fonts' => $fonts));
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ($vars) {
			...
			// Make theme-specific fonts rules
			$vars = callie_britt_customizer_add_theme_vars($vars);
			extract($vars);
...
CSS;
			$rez = apply_filters('callie_britt_filter_get_css', $rez, array('vars' => $vars));
			$css['vars'] = $rez['vars'];
		}
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($scheme) ? array_keys(callie_britt_get_sorted_schemes()) : array($scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $s) {
					// Prepare colors
					if (empty($scheme)) $colors = callie_britt_get_scheme_colors($s);
	
					// Make theme-specific colors and tints
					$colors = callie_britt_customizer_add_theme_colors($colors);
...
.post_item.hentry .more-link {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link']};
}
.post_item.hentry .more-link:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link_07']};
}
.post_item.sticky.hentry .more-link {
	color: {$colors['text_link']};
	background-color: {$colors['inverse_link']};
}
.post_item.sticky.hentry .more-link:hover {
	color: {$colors['text_hover']};
	background-color: {$colors['inverse_link']};
}
.post_item.has-post-thumbnail.hentry .more-link {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link']};
}
.post_item.has-post-thumbnail.hentry .more-link:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link_07']};
}
.related_item_style_2 .post_meta .post_meta_item.post_categories a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
.related_item_style_2 .post_meta .post_meta_item.post_categories a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
.related_item_style_2 .post_header_categories .post_meta_item.post_categories a {
	color: {$colors['text_link']};
	background-color: {$colors['inverse_link']};
}
.related_item_style_2 .post_header_categories .post_meta_item.post_categories a:hover {
	color: {$colors['text_hover']};
	background-color: {$colors['inverse_link']};
}
...
.widget.widget_contacts .contacts_info a.contacts_phone:hover {
	color: {$colors['text_link']};
}
.widget.widget_contacts .contacts_info span.contacts_email a {
	color: {$colors['alter_text']};
}
.widget.widget_contacts .contacts_info span.contacts_email a:hover {
	color: {$colors['text_link']};
}
...
.widget.widget_contacts .contacts_info span.contacts_email:hover:before,
.widget.widget_contacts .contacts_info a.contacts_phone:hover:before {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_hover']};
}
.sc_services.sc_services_default.sc_services_featured_top h2.sc_item_title {
	color: {$colors['text_link3']};
}
.sc_services_item_info h4.sc_services_item_title a {
	color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_cart.inited:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_cart.inited:hover .sc_layouts_item_icon {
	color: {$colors['text_hover2']};
}
...
.sc_layouts_row_type_compact .search_form:hover {
	border-color: {$colors['text_hover2']};
}
.sc_layouts_row_type_compact input.search_field:focus .search_form {
	border-color: {$colors['alter_link']};
}
...
.sc_layouts_row_type_compact .trx_addons_login_link:hover > span:before,
.sc_layouts_row_type_compact .sc_layouts_item_link.sc_layouts_iconed_text_link:hover > span:before,
.sc_layouts_row_type_compact .sc_layouts_cart.inited:hover > span:before {
	background-color: {$colors['alter_link']};
}
.sc_layouts_row_type_compact .sc_layouts_item_link.sc_layouts_iconed_text_link:hover 
.sc_layouts_item_details_line1.sc_layouts_iconed_text_line1 {
	color: {$colors['alter_link']};
}
.sc_layouts_row_type_normal .sc_layouts_item_link.sc_layouts_iconed_text_link:hover 
.sc_layouts_item_details_line1.sc_layouts_iconed_text_line1 {
	color: {$colors['alter_link']};
}
.sc_layouts_row_type_compact .trx_addons_login_link:hover > span:before {
...
.sc_layouts_row_type_compact .sc_layouts_item_link:hover {
	color: {$colors['inverse_text']};
}
...
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_icon:before {
	background-color: {$colors['text_hover2']};
}
.sc_layouts_row_type_compact .sc_layouts_item_icon:hover:before,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_icon:hover:before {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link']};
}
.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button .sc_layouts_item_icon:before,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button .sc_layouts_item_icon:before {
	color: {$colors['alter_link']};
	background-color: transparent;
}
.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button .sc_layouts_item_icon:hover:before,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button .sc_layouts_item_icon:hover:before {
	color: {$colors['text_hover2']};
	background-color: transparent;
}
...
.footer_wrap .sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button):hover {
	color: {$colors['text_hover2']};
}
...
.sc_layouts_row_type_normal .socials_wrap .social_item .social_icon:hover,
.scheme_self .sc_layouts_row_type_normal .socials_wrap .social_item .social_icon:hover {
	color: {$colors['text_hover2']};
}
.sc_layouts_row_type_normal .sc_layouts_menu_nav > li > a:hover:before,
.scheme_self .sc_layouts_row_type_normal .sc_layouts_menu_nav > li > a:hover:before {
	background-color: {$colors['alter_link']};
}
.sc_layouts_row_type_normal .sc_layouts_menu_nav > li.current-menu-item > a:before,
.scheme_self .sc_layouts_row_type_normal .sc_layouts_menu_nav > li.current-menu-item > a:before {
	background-color: {$colors['alter_link']};
}
.sc_layouts_row_type_normal .sc_layouts_menu_nav > li.current-menu-ancestor > a:before,
.scheme_self .sc_layouts_row_type_normal .sc_layouts_menu_nav > li.current-menu-ancestor > a:before {
	background-color: {$colors['alter_link']};
}
...
.sc_layouts_row_type_normal .sc_layouts_item_icon.trx_addons_icon-menu,
.scheme_self .sc_layouts_row_type_normal .sc_layouts_item_icon.trx_addons_icon-menu {
	color: {$colors['alter_link']};
	background-color: transparent;
}
.sc_layouts_row_type_normal .sc_layouts_item_link.sc_layouts_iconed_text_link:hover .sc_layouts_item_icon.icon-phone-2 {
	background-color: {$colors['alter_link']};
}
.sc_layouts_row_type_normal .sc_layouts_item_icon.trx_addons_icon-menu:hover,
.scheme_self .sc_layouts_row_type_normal .sc_layouts_item_icon.trx_addons_icon-menu:hover {
	color: {$colors['text_hover2']};
	background-color: transparent;
}
...
.scheme_self .sc_layouts_row_type_normal .sc_layouts_item_icon:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link']};
}
...
.post_info .post_info_item:hover:before {
	color: {$colors['text_dark']};
}
.post_info .post_info_item:hover a {
	color: {$colors['text_hover']};
}
...
.sc_layouts_menu_nav > li.menu-item.menu-collapse > a:before {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_hover2']};
}
.sc_layouts_menu_nav > li.menu-item.menu-collapse > a:hover:before {
	color: {$colors['inverse_text']};
	background-color: {$colors['alter_link']};
}
...
.sc_layouts_menu_popup .sc_layouts_menu_nav,
.sc_layouts_menu_nav > li ul ul ul:after {
	background-color: {$colors['extra_bd_color']};
}
...
.sc_layouts_menu_nav > li li.sfHover > a {
	...
	background-color: {$colors['inverse_bd_color_02']};
}
...
.menu_mobile_inner a span.logo_text {
	color: {$colors['text_hover3']};
}
.menu_mobile_inner a span.logo_slogan {
	color: {$colors['inverse_text']};
}
...
.menu_mobile .search_mobile 
input.search_field[type="text"]:hover {
	border-color: {$colors['extra_link']};
}
.menu_mobile .search_mobile 
input.search_field[type="text"]:focus {
	border-color: {$colors['extra_link']};
}
...
.top_panel_default .top_panel_title .post_meta_item.post_categories a {
	color: {$colors['extra_bg_color']};
	background-color: {$colors['inverse_text']};
}
.top_panel_default .top_panel_title .post_meta_item.post_categories a:hover {
	color: {$colors['alter_link']};
}
.top_panel_default .top_panel_title .post_meta_item.post_date:before,
.top_panel_default .top_panel_title .post_meta_item.post_date:after,
.top_panel_default .top_panel_title .post_meta_item.post_date a {
	color: {$colors['inverse_text']};
}
.top_panel_default .top_panel_title .post_meta_item.post_date:hover:before,
.top_panel_default .top_panel_title .post_meta_item.post_date:hover a {
	color: {$colors['alter_link3']};
}
.top_panel_default .top_panel_title .post_meta_item.post_counters_item:before,
.top_panel_default .top_panel_title .post_meta_item.post_counters_item span,
.top_panel_default .top_panel_title .post_meta_item.post_counters_item:after {
	color: {$colors['inverse_text']};
}
.top_panel_default .top_panel_title .post_meta_item.post_counters_item:hover:before,
.top_panel_default .top_panel_title .post_meta_item.post_counters_item:hover span {
	color: {$colors['alter_link3']};
}
.top_panel_default .top_panel_title .post_meta_item.post_edit:before,
.top_panel_default .top_panel_title a.post_meta_item.post_edit {
	color: {$colors['inverse_text']};
}
.top_panel_default .top_panel_title .post_meta_item.post_edit:hover:before,
.top_panel_default .top_panel_title a.post_meta_item.post_edit:hover {
	color: {$colors['alter_link3']};
}
.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item.post_author {
	color: {$colors['inverse_link']};
}
.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item.post_author:after {
	color: {$colors['inverse_link']};
}
.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item.post_author:hover {
	color: {$colors['alter_link3']};
}

.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item .socials_caption {
	color: {$colors['inverse_link']};
}
.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item .socials_caption:hover {
	color: {$colors['alter_link3']};
}
.top_panel.top_panel_default .sc_layouts_title_meta .post_meta_item:after {
	color: {$colors['inverse_link']};
}
...
.callie_britt_tabs .callie_britt_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton > span:hover {
...
.callie_britt_tabs .callie_britt_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span {
...
.sheme_self.sidebar .callie_britt_tabs .callie_britt_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .callie_britt_tabs .callie_britt_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .callie_britt_tabs .callie_britt_tabs_titles li.ui-state-active a {
...
.post_item.hentry .post_meta a:hover {
	color: {$colors['text_hover']};
}
.post_item.sticky.hentry .post_meta span {
	color: {$colors['text_link']};
}
.post_item.sticky.hentry .post_meta a {
	color: {$colors['text_link']};
}
.post_item.sticky.hentry .post_meta .post_meta_item.post_author {
	color: {$colors['inverse_link']};
}
.post_item.sticky.hentry .post_meta .post_meta_item.post_author:hover {
	color: {$colors['text_link3']};
}
.post_item.post_layout_chess.sticky.hentry .post_meta .post_meta_item.post_categories a {
	color: {$colors['text_link']};
	background-color: {$colors['inverse_text']};
}
.post_item.post_layout_chess.sticky.hentry .post_meta .post_meta_item.post_categories a:hover {
	color: {$colors['alter_link']};
}
.post_item.sticky.hentry .post_meta .post_date a {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_date:before {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_date:after {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_date:hover a,
.post_item.sticky.hentry .post_meta .post_date:hover:before {
	color: {$colors['text_link3']};
}
.post_item.sticky.hentry .post_meta .post_counters_comments {
	color: {$colors['inverse_text']};
}
...
.post_item.sticky.hentry .post_meta .post_counters_comments:after {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_counters_comments:hover,
.post_item.sticky.hentry .post_meta .post_counters_comments:hover span,
.post_item.sticky.hentry .post_meta .post_counters_comments:hover:before {
	color: {$colors['text_link3']};
}
.related_item .post_meta .post_meta_item:hover:before {
	color: {$colors['text_link3']};
}
.post_item.hentry .post_meta .post_meta_item:after,
.post_item.hentry .post_meta .post_meta_item:before {
	color: {$colors['text_light']};
}
.related_wrap .related_item .post_meta .post_meta_item:after {
	color: {$colors['text_light']}!important;
}
.post_item.hentry .post_meta .post_meta_item:hover:before {
	color: {$colors['text_link3']};
}
.post_item.sticky.hentry .post_meta .post_meta_item.post_edit:hover:before {
	color: {$colors['text_link3']};
}
.post_item.hentry .post_meta .post_date:before {
	color: {$colors['text_hover']};
}
.post_item.hentry .post_meta .post_counters_comments:before {
	color: {$colors['text_hover']};
}
.post_item.hentry .post_meta .post_edit:before {
	color: {$colors['text_hover']};
}
.post_item.hentry .post_meta .post_edit:hover:before {
	color: {$colors['text_dark']};
}
.post_item.sticky.hentry .post_meta .post_edit {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_edit:before {
	color: {$colors['inverse_text']};
}
.post_item.sticky.hentry .post_meta .post_edit:hover {
	color: {$colors['text_link3']};
}
.post_item.sticky.hentry .post_meta .post_edit:hover:before {
	color: {$colors['text_link3']};
}
.post_item.has-post-thumbnail.hentry .post_meta .post_date:before {
	color: {$colors['text_hover']};
}
.post_item.has-post-thumbnail.hentry .post_meta .post_counters_comments:before {
	color: {$colors['text_hover']};
}
.post_item.has-post-thumbnail.hentry .post_meta .post_date:hover:before {
	color: {$colors['text_dark']};
}
.post_item.has-post-thumbnail.hentry .post_meta .post_counters_comments:hover:before {
	color: {$colors['text_dark']};
}
...
.has-post-thumbnail .post_date a:hover {
	color: {$colors['text_hover']};
}
.has-post-thumbnail .post_meta .post_meta_item:after {
	color: {$colors['text_light']};
}
.has-post-thumbnail .post_meta .post_meta_item:before {
	color: {$colors['alter_link']};
}
.post_meta .post_meta_item.post_date:hover:before {
	color: {$colors['text_dark']};
}
.post_meta .post_meta_item.post_counters_comments:hover:before {
	color: {$colors['text_dark']};
}
.related_item_style_2 .post_title.entry-title a {
	color: {$colors['alter_text']};
}
.related_item_style_2 .post_title.entry-title a:hover {
	color: {$colors['text_link']};
}
.post_date a:hover,
...
.post_item.post_layout_excerpt .post_meta_item.post_categories a,
.post_item.post_layout_classic .post_meta_item.post_categories a,
.post_item.post_layout_chess .post_meta_item.post_categories a {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
.post_item.post_layout_excerpt .post_meta_item.post_categories a:hover,
.post_item.post_layout_classic .post_meta_item.post_categories a:hover,
.post_item.post_layout_chess .post_meta_item.post_categories a:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_hover']};
}
.post_item.post_layout_excerpt.sticky .post_meta_item.post_categories a {
	color: {$colors['text_hover2']};
	background-color: {$colors['inverse_text']};
}
.post_item.post_layout_excerpt.sticky .post_meta_item.post_categories a:hover {
	color: {$colors['alter_link']};
	background-color: {$colors['inverse_text']};
}
.post_item.post_layout_excerpt.sticky .post_header_categories .post_meta_item.post_categories a,
.post_item.post_layout_classic.sticky .post_header .post_meta_item.post_categories a, 
.post_item.post_layout_excerpt .post_header_categories .post_meta_item.post_categories a,
.post_item_single.has-post-thumbnail .post_header_categories .post_meta_item.post_categories a {
	color: {$colors['text_link']};
	background-color: {$colors['inverse_text']};
}
.post_item_single .post_header_categories .post_meta_item.post_categories a {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_hover2']};
}
.post_item_single .post_header_categories .post_meta_item.post_categories a:hover {
	background-color: {$colors['alter_link']};
}
.post_item.post_layout_excerpt.sticky .post_header_categories .post_meta_item.post_categories a:hover, 
.post_item.post_layout_classic.sticky .post_header .post_meta_item.post_categories a:hover, 
.post_item.post_layout_excerpt .post_header_categories .post_meta_item.post_categories a:hover,
.post_item_single.has-post-thumbnail .post_header_categories .post_meta_item.post_categories a:hover {
	color: {$colors['text_hover']};
	background-color: {$colors['inverse_text']};
}
.post_item.post_layout_excerpt.sticky .post_header_categories .post_meta_item.post_categories a {
...
.sc_blogger_default .post_header_categories .post_meta_item.post_categories a {
	color: {$colors['text_link']};
	background-color: {$colors['inverse_text']};
}
.sc_blogger_default .post_header_categories .post_meta_item.post_categories a:hover {
	color: {$colors['alter_link']};
	background-color: {$colors['inverse_text']};
}
.post_featured:empty + .post_header_categories .post_meta_item a {
	color: {$colors['inverse_text']}!important;
	background-color: {$colors['text_hover2']}!important;
}
.post_featured:empty + .post_header_categories .post_meta_item a:hover {
	color: {$colors['inverse_text']}!important;
	background-color: {$colors['alter_link']}!important;
}
...
.post_item_single.post_type_page li {
	border-color: {$colors['alter_bd_color']};
}
...
.post_item_single.post_type_page .tribe-bar-views-list li span {
	background-color: transparent;
}
...
.mejs-time-float-corner {
	border-top-color: {$colors['alter_link3']};
}
...
.sticky .post_title.entry-title a {
	color: {$colors['inverse_text']};
}
.sticky .post_title.entry-title a:hover {
	color: {$colors['text_link3']};
}
...
.related_item_style_2 .post_content .more-link:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
...
CSS;
					...
					$rez = apply_filters('callie_britt_filter_get_css', $rez, array('colors' => $colors, 'scheme' => $s));
		...
		return apply_filters( 'callie_britt_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>