== Callie Britt ==
Version: 1.0
Copyright: 2018, Axiom
WordPress version: required at least 4.5, tested up to 4.9.8
...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Callie Britt'.
Please install and activate it before starting to use the theme Callie Britt.
Also the theme supports many popular plugins such as 'Revolution Slider', 'Visual Composer'
and many more.


III. Documentation

Theme documentation is available on http://callie-britt.axiom.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Callie Britt is Fontello.
